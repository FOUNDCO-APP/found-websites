...
.00 due on the first invoice and did not duplicate on verification. Next test: fresh onboarding, choose Found Starter, apply `FND-E8529646-AA9714`, activate, and verify Stripe invoice/subscription plus Found activation state.
