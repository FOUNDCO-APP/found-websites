...
.00 due on the first invoice and did not duplicate on verification. Next test: fresh onboarding, choose Found, apply FOUND1, activate, and verify Stripe invoice/subscription plus Found activation state.
