    ...
    <>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 px-8 max-w-5xl w-full">
          <p className="text-xs font-black tracking-[0.3em] uppercase mb-6" style={{ color: "#ffffff" }}>
          ...
          <div className="w-16 h-1 mx-auto mb-8" style={{ backgroundColor: primary }} />
          <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-12 leading-relaxed" style={{ color: "#dddddd" }}>
