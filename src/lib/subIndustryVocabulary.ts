...
const retailVocab: Record<string, SubIndustryVocab> = {
  ...
  bookstore: {
    ...retailDefaults,
    servicesLabel: "What We Carry",
    servicesOverline: "On the Shelves",
    galleryLabel: "On the Shelves",
    reviewsLabel: "What Readers Say",
    reviewsOverline: "Reader Reviews",
    ctaBodyText: "come browse the shelves — there's always something new to find",
    customerWord: "reader",
  },
  "hardware store": {
    ...retailDefaults,
    servicesLabel: "What We Carry",
    servicesOverline: "Tools & Supplies",
    galleryLabel: "In the Aisles",
    ctaBodyText: "come in — we'll help you find the right tool or part",
  },
  "pet supply store": {
    ...retailDefaults,
    servicesLabel: "What We Carry",
    servicesOverline: "For Your Pet",
    galleryLabel: "For the Pets",
    ctaBodyText: "come in — we'll help you find exactly what your pet needs",
  },
  "furniture store": {
    ...retailDefaults,
    servicesLabel: "The Collection",
    servicesOverline: "What We Carry",
    galleryLabel: "In the Showroom",
    ctaBodyText: "come see it in person — furniture always looks better in the room",
  },
  florist: {
    ...retailDefaults,
