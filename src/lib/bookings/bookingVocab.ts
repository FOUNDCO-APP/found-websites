...
const BOOKING_NOUN_MAP: Partial<Record<string, BookingNoun>> = {
  ...
  audio_visual:          { noun: "consultation",        pastTense: "scheduled",  confirmMode: "soft" },
...
const SERVICE_FIELD_MAP: Partial<Record<string, ServiceField>> = {
  ...
  audio_visual:          { label: "Service type",
                           options: ["Home Theater", "Car Audio", "Commercial AV", "Smart Home", "Other"] },
