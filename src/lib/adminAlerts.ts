  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:420px;">
        ...
        <tr><td>
          <a href="https://my.${ROOT_DOMAIN}/admin/clients?q=${encodeURIComponent(company.name)}" style="display:inline-block;border-radius:4px;padding:12px 20px;background:${GREEN};color:${BLACK};text-decoration:none;font-size:13px;font-weight:800;">View in Found HQ</a>
        </td></tr>
      </table>
    </td></tr>
  </table>
