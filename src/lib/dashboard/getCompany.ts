...
const SELECT_FIELDS =
  "id, name, slug, email, phone, plan, subscription_status, stripe_customer_id, stripe_connect_account_id, pending_setup_intent_secret, is_founding_member, primary_color, user_id, city, state, address, zip, address_visible, industry_category, sub_industry, form_intent, primary_intent, primary_action_override, default_tax_rate, is_comp, admin_notes, logo_url, logo_white_url"
