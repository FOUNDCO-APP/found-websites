...
export const industryManifests: Record<string, IndustryManifest> = {
  ...
  audio_visual: {
    label: "Audio & Visual",
    primaryJob: "Show real installs, prove technical skill, and make it easy to request a quote for a home theater, sound system, or AV project.",
    sections: ["hero", "trust_strip", "services", "portfolio", "process", "reviews", "final_cta"],
    requiredFields: ["service_types", "licensed_insured", "service_areas", "free_estimate_or_consult"],
    subIndustries: ["home theater installer", "car audio installer", "commercial av installer", "sound engineer", "smart home integrator", "speaker installer"],
    preferredPhotoTags: ["audio", "home theater", "installation", "equipment", "general"],
    primaryIntent: "quote",
    secondaryIntent: "call",
    likelyUpgrades: ["estimates_quotes", "before_after_gallery", "custom_domain"],
    jonyNote: "This is a technical trust business — customers want to see real equipment and real installs, not stock photos of speakers. Show the actual work.",
    layoutHints: { bold: "impact", calm: "editorial", modern: "editorial", warm: "portrait" },
  },
  nonprofit: {
