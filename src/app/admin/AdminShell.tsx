...
const NAV_ITEMS = [
  ...
  { href: "/admin/more", label: "More", icon: "more", match: ["/admin/more", "/admin/activity", "/admin/photos", "/admin/copy", "/admin/health", "/admin/billing", "/admin/new-client", "/admin/test-center"] },
] as const
