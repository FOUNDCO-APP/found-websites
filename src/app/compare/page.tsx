...
export default function ComparePage() {
  return (
    <IndustryPage
      ...
      faqs={[
        { q: "What makes Found different from Wix or Squarespace?", a: "Wix and Squarespace can now auto-draft a starting site with AI, but real customization after that still takes real time — often a few hours to a full day — inside their drag-and-drop editor. Found skips the editor completely: you answer a few questions, and the finished site is what goes live. No sections to drag, no fonts to pick, nothing left for you to design." },
