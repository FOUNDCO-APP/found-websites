            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                ...
                ${email ? `<td style="padding-left:8px;">
                  <a href="mailto:${email}" style="display:block;text-align:center;background:#f0f0f0;color:#111111;font-size:14px;font-weight:800;padding:16px;border-radius:50px;text-decoration:none;">Reply by Email</a>
                </td>` : ""}
              </tr>
            </table>
          </td>
