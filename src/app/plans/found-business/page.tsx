  ...
  return (
    <PlanPage
      ...
      features={[
        ...
        { label: "More five-star reviews, without the awkward ask", desc: "When you mark a job complete, Found automatically sends the client a review request. You don't have to remember, feel awkward, or follow up. The request goes out — clients who are happy, leave reviews." },
      ...
      faqs={[
        { q: "Is this really everything I need to run my business?", a: "For most local service businesses — yes. Website, booking, estimates, invoicing, reviews, team management, and social content all in one place. The goal is to replace the scattered stack of tools you're already paying for." },
