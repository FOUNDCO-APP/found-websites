...
export const metadata: Metadata = {
  ...
  description: "A professional contractor website built for your trade. Your services, your photos, leads coming straight to your phone. Starting at $29/month — intro rate expires August 15.",
  openGraph: {
