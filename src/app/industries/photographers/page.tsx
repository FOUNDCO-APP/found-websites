  ...
  return (
    <IndustryPage
      ...
      features={[
        ...
        { label: "Every inquiry answered instantly", desc: "When a potential client contacts you, they immediately get a professional response. You look available and responsive even when you're on a shoot." },
        ...
        { label: "Found by people searching for photographers near them", desc: "Found sites are structured for local photography searches — wedding photographer, portrait photographer, headshots in [city]. Your specialty and location are connected the way Google needs." },
      ]}
      faqs={[
        ...
        { q: "Will clients find me when they search for a photographer?", a: "Yes. Found sites include your photography specialty, your location, and your business name structured the way Google needs. Most photographers start appearing in local search results within a few weeks." },
