  ...
  return (
    <IndustryPage
      ...
      features={[
        ...
        { label: "Found by locals searching for food near them", desc: "Found sites are structured to appear in local food searches. Your neighborhood, your cuisine type, your name — all connected the way Google needs to find you." },
      ]}
      faqs={[
        ...
        { q: "Will people find my restaurant on Google?", a: "Found sites are built to help local restaurants show up in Google searches. Your location, your cuisine, and your business name are all structured the way Google needs to connect you with nearby diners." },
      ...
      closingLine="Your restaurant deserves a table at the top of search results."
    />
  )
}
