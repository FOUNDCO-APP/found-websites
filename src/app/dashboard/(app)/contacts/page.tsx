...
// Placeholder — will wire to Supabase in next pass
const SAMPLE: Contact[] = []

export default function ContactsPage() {
  const [contacts] = useState<Contact[]>(SAMPLE)
  ...
  const filtered = filterTag ? contacts.filter(c => c.tags.includes(filterTag)) : contacts
      ...
      {showAdd && (
        <div style={{
          ...
          {[
            ...
            { label: "Notes", val: newNotes, set: setNewNotes, placeholder: "e.g. great drywall work" },
          ...
          <div key={contact.id} style={{
            ...
            <div style={{ padding: "16px 18px", display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ display: "flex", gap: 12, flexShrink: 0 }}>
                {contact.phone && (
                  <a href={`tel:${contact.phone.replace(/\D/g, "")}`} style={{ color: "rgba(255,255,255,0.3)", display: "flex" }}>
                ...
                {contact.phone && (
                  <a href={`sms:${contact.phone.replace(/\D/g, "")}`} style={{ color: "rgba(255,255,255,0.3)", display: "flex" }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                {contact.email && (
                  <a href={`mailto:${contact.email}`} style={{ color: "rgba(255,255,255,0.3)", display: "flex" }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
