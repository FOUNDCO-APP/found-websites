    ...
    <>
      <section className="py-24 text-white" style={{ background: gradient }}>
        <div className="max-w-6xl mx-auto px-8">
          <p className="text-xs font-black tracking-widest uppercase mb-4" style={{ color: primary }}>Get In Touch</p>
          <h1 className="text-5xl md:text-6xl font-black mb-5" style={{ fontFamily: "var(--font-heading, inherit)" }}>Contact Us</h1>
          <p className="text-lg max-w-xl" style={{ color: "#888888" }}>We&apos;d love to hear from you.</p>
        </div>
      </section>
