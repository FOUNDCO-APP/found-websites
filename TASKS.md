...
- [ ] Extend the Apple-style plan carousel pattern beyond industry pages only after mobile QA passes: homepage pricing, plans page, and other pricing CTAs should use the same Pro-first, one-card-at-a-time mobile pattern instead of squeezed three-card layouts.
