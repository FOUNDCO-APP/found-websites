...
assert(business.hasOfferCatalog.itemListElement[0]["@type"] === "ListItem", "offer catalog order should use ListItem")
assert(business.hasOfferCatalog.itemListElement[0].position === 1, "service list position should live on ListItem")
assert(business.hasOfferCatalog.itemListElement[0].item["@type"] === "Offer", "service list item should contain an Offer")
